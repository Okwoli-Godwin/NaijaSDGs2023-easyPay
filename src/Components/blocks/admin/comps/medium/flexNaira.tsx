...
const FlexNaira: React.FC = () => {
  ...
  return (
    <div className="w-full grid grid-cols-3 gap-5 max-[800px]:grid-cols-1">
          ...
          <div className="flex items-center gap-4 my-2">
            <div
              ...
              style={{
                ...
                color: all ? "var(--primary-color)" : "var(--secondary-color)",
                backgroundColor: all
                  ? "var(--accent-color)"
                  : "var(--primary-color)",
              }}
      ...
      <div>
        <div className="w-full px-2 py-4 bg-[var(--accent-color)] text-[var(--primary-color)] rounded-[5px] font-medium flex justify-center items-center">
          GET ACCOUNT NUMBER
        </div>
      </div>
    </div>
