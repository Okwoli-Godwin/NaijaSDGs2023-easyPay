...
const Hero = () => {
        ...
        return (
            <section>
                <div className="max-w-screen-xl  mx-auto px-4 py-36 gap-12 text-gray-600 md:px-8 xl:flex">
                    <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
                        ...
                        Business Payments Made <br />  <span style={{color: "#716DF2", marginTop: "10px"}}>
              <Typewriter
              ...
              />
                        ...
                        Get a unique bank account number that enables your company to pay employees' salaries through the wallet.
                        </p>
